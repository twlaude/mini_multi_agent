...
실행: PARKING_DSN=postgresql://parking:parking@localhost:5432/parking python3 db/seed_extra.py
...
DSN = os.environ.get("PARKING_DSN", "postgresql://parking:parking@localhost:5432/parking")
